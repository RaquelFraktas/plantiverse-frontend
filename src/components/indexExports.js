...
export {default as PlantShow } from './PlantShow' ;
...
export {default as ForumIndex } from '../containers/ForumIndex'
export {default as ForumCard } from './ForumCard'
export {default as ForumShow } from './ForumShow'
export {default as ForumNewPost } from './ForumNewPost'
export {default as CommentIndex } from '../containers/CommentIndex'
